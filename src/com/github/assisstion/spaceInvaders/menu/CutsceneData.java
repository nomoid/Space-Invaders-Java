...
public final class CutsceneData{
	public static final class Cutscene1{
		...
		private static final Font[] FONTLIST =  {new Font("Helvetica", Font.PLAIN, 50), SYSTEMFONT, SYSTEMFONT, SYSTEMFONT, DEFAULTFONT,DEFAULTFONT,DEFAULTFONT,DEFAULTFONT,DEFAULTFONT,new Font("Copperplate Gothic Bold", Font.BOLD, 50),SYSTEMFONT, DEFAULTFONT,DEFAULTFONT,new Font("Copperplate Gothic Bold", Font.BOLD, 50),SYSTEMFONT, DEFAULTFONT, SYSTEMFONT,DEFAULTFONT,DEFAULTFONT,DEFAULTFONT,DEFAULTFONT,DEFAULTFONT,DEFAULTFONT,DEFAULTFONT,DEFAULTFONT, ALIENFONT, DEFAULTFONT, SYSTEMFONT, SYSTEMFONT, DEFAULTFONT, DEFAULTFONT, DEFAULTFONT, DEFAULTFONT, DEFAULTFONT, DEFAULTFONT, DEFAULTFONT, DEFAULTFONT, DEFAULTFONT,DEFAULTFONT,DEFAULTFONT, DEFAULTFONT};
		...
		private static final double[] DELAYLIST = {5,5,5,5,20,5,5,10,10,5,10,10,10,10,15,20,15,15,20,15,20,20,20,15,20,15,10,15,15,15,10,25,25,15,15,20,20,15,20,20,20,20};
		public static final Cutscene SCENE = new Cutscene(PAGES, SPRITES,DELAYLIST,FONTLIST,COLORLIST);
	}
}